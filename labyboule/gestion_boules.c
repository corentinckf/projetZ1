...
#include "gestion_boules.h"

void creer_entite(SDL_Window *window, SDL_Renderer *renderer, int pos_prec, int pos_cour, int vitesse, int vertical, int horizontal, boule_t *entite, char *chemin)
{
...
void charger_texture(SDL_Window *window, SDL_Renderer *renderer, boule_t *entite, char *chemin)
{
